...
const mutation = `
  addRun(distance: Float!, time: String!, location: String, timeOfDay: TimeOfDay, date: String, comment: String, shoeId: ID, userId: ID!): Run
  updateRun(id: ID!, distance: Float, time: String, location: String, timeOfDay: TimeOfDay, date: String, comment: String, shoeId: ID, userId: ID): Run
  deleteRun(id: ID!): Run
`;
